...
export default function Case4_4() {
  ...
  useEffect(() => {
    ...
    // const planeWidth = 1;
    const planeWidth = 0.5; // 解决: 平面分割为2个, 那么每个长度为0.5
    const planeHeight = 1;
    ...
    makeInstance(geometry, "pink", 0, "/t_/happyface.png");
    makeInstance(geometry, "lightblue", Math.PI * 0.5, "/t_/hmmmface.png");
