...
import { GLTF, GLTFLoader, DRACOLoader, FBXLoader, RGBELoader } from "three-stdlib";
...
// 加载视频贴图
const loadVideoTexture = (src: string, options: Partial<LoadVideoOptions> = {}): Promise<THREE.VideoTexture> => {
...
// 加载GLTF模型
const loadGLTF = (path: string, config: Partial<LoadGLTFConfig> = {}): Promise<GLTF | null> => {
